...
const getLinkAnalytics = async(id,range) =>{
  const res = await Api.get(`/links/${id}/analytics?range=${range}`);
...
export {getLinks, getLink, createLink, getStats, updateLink, deleteLink, getLinkAnalytics};